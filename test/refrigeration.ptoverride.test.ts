...
describe('refrigeration PT override behavior', () => {
  it('uses ptOverride when refrigerant is OTHER', () => {
    const measurements = { mode: 'cooling', suctionPressure: 150, dischargePressure: 300, suctionTemp: 70, liquidTemp: 90, enteringWaterTemp: 80, leavingWaterTemp: 88 } as unknown as Record<string, unknown>;
