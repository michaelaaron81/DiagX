...
export const REFRIGERANT_DATA: Record<string, RefrigerantData> = {
  'R-410A': {
...
export function getRefrigerantTypes(): string[] {
  return Object.keys(REFRIGERANT_DATA);
}

export function getRefrigerantData(type: string): RefrigerantData | null {
  return REFRIGERANT_DATA[type] || null;
}

export function isValidRefrigerant(type: string): boolean {
