...
export interface HydronicProfileConfig {
  ...
  // keep compatibility with profile loopType values (closed_tower used across profiles)
...
export type HydronicEngine = (
  measurements: HydronicMeasurements,
  context: HydronicEngineContext
