## Policy: No OEM/IOM Manufacturer Tables in Repository

We intentionally keep the repository free of OEM or IOM manufacturer-specific performance tables that could be misconstrued or accidentally committed.
