...
The engine delegates all thermodynamic and electrical calculations to the Physics Kernel:

| Kernel Function | Used For |
|-----------------|----------|
| `computeCompressionRatio(dischargePressure, suctionPressure)` | Pressure ratio calculation |
| `computePercentRLA(measuredCurrent, rla)` | Current as percentage of rated load amps |
