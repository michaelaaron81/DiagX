...
|-----------------|----------|
| `computeAirDeltaT(supplyAirTemp, returnAirTemp)` | Air temperature differential |
| `computeAirflowFromDeltaT(nominalTons, deltaT)` | Estimated airflow from sensible heat equation |
| `computeCFMPerTon(cfm, nominalTons)` | CFM per ton calculation |
