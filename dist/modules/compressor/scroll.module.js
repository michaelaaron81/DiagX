...
export const scrollCompressorMetadata = {
...
export const scrollCompressorHelp = {
    measurementHelp: {
...
export class ScrollCompressorDiagnosticModule {
    constructor() {
        this.metadata = scrollCompressorMetadata;
        this.help = scrollCompressorHelp;
    }
    validate(measurements) {
        const errors = [];
        if (measurements.suctionPressure === undefined)
            errors.push('suctionPressure required');
        if (measurements.dischargePressure === undefined)
            errors.push('dischargePressure required');
    ...
    summarizeForReport(diagnosis, profile) {
        ...
        if (diagnosis.dischargeSuperheat !== undefined)
            lines.push(`Discharge delta: ${formatTemperature(diagnosis.dischargeSuperheat)}`);
