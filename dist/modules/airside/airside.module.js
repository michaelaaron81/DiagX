...
export class AirsideDiagnosticModule {
    constructor() {
        this.metadata = airsideMetadata;
        this.help = airsideHelp;
    }
    ...
    diagnose(measurements, profile) {
        ...
        if (!validation.ok) {
            ...
            if (hasError) {
                const err = new Error('Airside measurement validation failed');
